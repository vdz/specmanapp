...
export class NewSectionCompact extends React.Component {
                    ...
                    <form>
                        <div className="form-group row">
                            <div className="offset-sm-2 col-sm-10">
                                <h3 className='display-6'>Create new section</h3>
                            </div>
                        </div>
                        <div ref='group'
                            ...
                            <div className="col-sm-10">
                                <input type="text" 
                                       ref='name'
                                       className="form-control" id="inputName" placeholder="Section name" />
                            </div>
                        </div>
                        <div className="form-group row">
