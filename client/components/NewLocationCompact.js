...
export class NewLocationCompact extends React.Component {
    ...
    render() {
        return  <section className='NewLocationCompact container'>
                    <form>
                        ...
                        <div ref='group'
                            ...
                            <div className="col-sm-10">
                                <input type="text" 
                                       ref='name'
                                       className="form-control" id="inputName" placeholder="Location name" />
                            </div>
                        </div>
                        <div className="form-group row">
